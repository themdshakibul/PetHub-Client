...
const MyListingCard = ({ pets }) => {
  // যদি কোনো কারণে ডেটা লোড হতে লেট হয় বা খালি থাকে তবে ক্র্যাশ এড়ানোর জন্য সেফটি চেক
  if (!pets) return null;
  ...
  // ইমেজ মিসিং থাকলে বা ইনভ্যালিড লিঙ্কের জন্য একটি ডিফল্ট ইমেজ প্লেসহোল্ডার
  const displayImage =
    petImageUrl ||
    "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600";
      ...
      <div className="px-4 py-3">
        <div className="flex justify-between items-start mb-2">
          <div className="max-w-[65%]">
            <h3 className="text-lg font-black tracking-tight text-slate-800 dark:text-white group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors duration-300 truncate">
              {petName}
            </h3>
            <p className="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-0.5 truncate">
